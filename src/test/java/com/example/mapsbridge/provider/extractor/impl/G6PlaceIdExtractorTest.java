...
import com.example.mapsbridge.provider.extractor.google.G6PlaceIdExtractor;
...
class G6PlaceIdExtractorTest {
    ...
    @BeforeEach
    void setUp() {
        extractor = new G6PlaceIdExtractor(mockGeocodingService, mockUrlPatternExtractor);
    }
